...
static inline void nccl_net_ofi_mem_defined(void *data, size_t size) { VALGRIND_MAKE_MEM_DEFINED(data, size); }

static inline void nccl_net_ofi_mem_undefined(void *data, size_t size) { VALGRIND_MAKE_MEM_UNDEFINED(data, size); }

static inline void nccl_net_ofi_mem_noaccess(void *data, size_t size) { VALGRIND_MAKE_MEM_NOACCESS(data, size); }
...
static inline void nccl_net_ofi_mem_destroy_mempool(void *handle) { VALGRIND_DESTROY_MEMPOOL(handle); }
