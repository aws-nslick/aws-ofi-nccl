...
static inline nvtxRangeId_t nvtx_start(const char *name, uint32_t color) { return nvtx_start_domain(false, 0, name, color); }

static inline void nvtx_end_domain(nvtxDomainHandle_t domain, nvtxRangeId_t id) { nvtxDomainRangeEnd(domain, id); }

static inline void nvtx_end(nvtxRangeId_t id) { nvtxRangeEnd(id); }

#define NCCL_OFI_TRACE_SEND_NVTX(dev, size, comm, msg_seq_num, request, nccl_req)                                                                              \
  do {                                                                                                                                                         \
    if (NCCL_OFI_NVTX_TRACE_PER_COMM) {                                                                                                                        \
      nvtxDomainHandle_t handle = ((nccl_net_ofi_rdma_send_comm_t *)comm)->nvtx_domain[msg_seq_num % NCCL_OFI_N_NVTX_DOMAIN_PER_COMM];                         \
      get_send_data(request)->trace_id = nvtx_start_domain(true, handle, "Send", 0xeb9234);                                                                    \
    }                                                                                                                                                          \
  } while (0)

#define NCCL_OFI_TRACE_SEND_END_NVTX(request)                                                                                                                  \
  do {                                                                                                                                                         \
    if (NCCL_OFI_NVTX_TRACE_PER_COMM) {                                                                                                                        \
      nvtxDomainHandle_t handle = ((nccl_net_ofi_rdma_send_comm_t *)(request->comm))->nvtx_domain[request->msg_seq_num % NCCL_OFI_N_NVTX_DOMAIN_PER_COMM];     \
      nvtx_end_domain(handle, get_send_data(request)->trace_id);                                                                                               \
    }                                                                                                                                                          \
  } while (0)

#define NCCL_OFI_TRACE_EAGER_SEND_START_NVTX(dev, rail_id, size, comm, msg_seq_num, request)                                                                   \
  do {                                                                                                                                                         \
...
#define NCCL_OFI_TRACE_EAGER_SEND_COMPLETE_NVTX(dev, rail_id, comm, msg_seq_num, request)                                                                      \
  do {                                                                                                                                                         \
    nvtxDomainHandle_t handle;                                                                                                                                 \
    if (NCCL_OFI_NVTX_TRACE_PER_COMM) {                                                                                                                        \
      handle = ((nccl_net_ofi_rdma_send_comm_t *)comm)->nvtx_domain[msg_seq_num % NCCL_OFI_N_NVTX_DOMAIN_PER_COMM];                                            \
...
#define NCCL_OFI_TRACE_SEND_CTRL_RECV_NVTX(dev, rail_id, comm, msg_seq_num)                                                                                    \
  do {                                                                                                                                                         \
    nvtxDomainHandle_t handle;                                                                                                                                 \
    if (NCCL_OFI_NVTX_TRACE_PER_COMM) {                                                                                                                        \
      handle = ((nccl_net_ofi_rdma_send_comm_t *)comm)->nvtx_domain[msg_seq_num % NCCL_OFI_N_NVTX_DOMAIN_PER_COMM];                                            \
...
#define NCCL_OFI_TRACE_SEND_CTRL_START_NVTX(dev, rail_id, comm, req, msg_seq_num)                                                                              \
  do {                                                                                                                                                         \
    nvtxDomainHandle_t handle;                                                                                                                                 \
    if (NCCL_OFI_NVTX_TRACE_PER_COMM) {                                                                                                                        \
...
#define NCCL_OFI_TRACE_SEND_CTRL_END_NVTX(dev, rail_id, comm, req, msg_seq_num)                                                                                \
  do {                                                                                                                                                         \
    nvtxDomainHandle_t handle;                                                                                                                                 \
    if (NCCL_OFI_NVTX_TRACE_PER_COMM) {                                                                                                                        \
      handle = ((nccl_net_ofi_rdma_recv_comm_t *)comm)->nvtx_domain[msg_seq_num % NCCL_OFI_N_NVTX_DOMAIN_PER_COMM];                                            \
...
#define NCCL_OFI_TRACE_SEND_WRITE_SEG_START_NVTX(dev, rail_id, size, comm, msg_seq_num, request)                                                               \
  do {                                                                                                                                                         \
    nvtxDomainHandle_t handle;                                                                                                                                 \
    if (NCCL_OFI_NVTX_TRACE_PER_COMM) {                                                                                                                        \
      handle = ((nccl_net_ofi_rdma_send_comm_t *)comm)->nvtx_domain[msg_seq_num % NCCL_OFI_N_NVTX_DOMAIN_PER_COMM];                                            \
...
#define NCCL_OFI_TRACE_SEND_WRITE_SEG_COMPLETE_NVTX(dev, rail_id, comm, msg_seq_num, request)                                                                  \
  do {                                                                                                                                                         \
    nvtxDomainHandle_t handle;                                                                                                                                 \
    if (NCCL_OFI_NVTX_TRACE_PER_COMM) {                                                                                                                        \
      handle = ((nccl_net_ofi_rdma_send_comm_t *)comm)->nvtx_domain[msg_seq_num % NCCL_OFI_N_NVTX_DOMAIN_PER_COMM];                                            \
...
#define NCCL_OFI_TRACE_RECV_NVTX(dev, tag, size, request, nccl_req)                                                                                            \
  do {                                                                                                                                                         \
    if (NCCL_OFI_NVTX_TRACE_PER_COMM) {                                                                                                                        \
      nvtxDomainHandle_t handle = ((nccl_net_ofi_rdma_recv_comm_t *)request->comm)->nvtx_domain[msg_seq_num % NCCL_OFI_N_NVTX_DOMAIN_PER_COMM];                \
      get_recv_data(request)->trace_id = nvtx_start_domain(true, handle, "Recv", 0x34EB37);                                                                    \
    }                                                                                                                                                          \
  } while (0)

#define NCCL_OFI_TRACE_RECV_END_NVTX(request)                                                                                                                  \
  do {                                                                                                                                                         \
    if (NCCL_OFI_NVTX_TRACE_PER_COMM) {                                                                                                                        \
      nvtxDomainHandle_t handle = ((nccl_net_ofi_rdma_recv_comm_t *)request->comm)->nvtx_domain[request->msg_seq_num % NCCL_OFI_N_NVTX_DOMAIN_PER_COMM];       \
      nvtx_end_domain(handle, get_recv_data(request)->trace_id);                                                                                               \
    }                                                                                                                                                          \
  } while (0)

#define NCCL_OFI_TRACE_RECV_SEGMENT_COMPLETE_NVTX(dev, rail_id, size, request, msg_seq_num)                                                                    \
  do {                                                                                                                                                         \
    nvtxDomainHandle_t handle;                                                                                                                                 \
    if (NCCL_OFI_NVTX_TRACE_PER_COMM) {                                                                                                                        \
...
#define NCCL_OFI_TRACE_EAGER_RECV_NVTX(dev, rail_id, comm, msg_seq_num)                                                                                        \
  do {                                                                                                                                                         \
    nvtxDomainHandle_t handle;                                                                                                                                 \
    if (NCCL_OFI_NVTX_TRACE_PER_COMM) {                                                                                                                        \
...
#define NCCL_OFI_TRACE_FLUSH_NVTX(request, nccl_req)                                                                                                           \
  do {                                                                                                                                                         \
    nvtx_mark_domain(NULL, "Flush", 0xA52A2A);                                                                                                                 \
  } while (0)

#define NCCL_OFI_TRACE_READ_NVTX(request, nccl_req)                                                                                                            \
  do {                                                                                                                                                         \
    nvtx_mark_domain(NULL, "Read", 0xff00ff);                                                                                                                  \
  } while (0)

#define NCCL_OFI_TRACE_WRITE_NVTX(request, nccl_req)                                                                                                           \
  do {                                                                                                                                                         \
    nvtx_mark_domain(NULL, "Write", 0xff00ff);                                                                                                                 \
  } while (0)

#define NCCL_OFI_TRACE_PENDING_INSERT_NVTX(request)                                                                                                            \
  do {                                                                                                                                                         \
    nvtx_mark_domain(NULL, "Pending_insert", 0xFF8C00);                                                                                                        \
  } while (0)

#define NCCL_OFI_TRACE_PENDING_REMOVE_NVTX(request)                                                                                                            \
  do {                                                                                                                                                         \
