 ...
 */
static inline nccl_ofi_freelist_elem_t *nccl_ofi_freelist_entry_alloc(nccl_ofi_freelist_t *freelist) {
  int ret;
 ...
 */
static inline void nccl_ofi_freelist_entry_free(nccl_ofi_freelist_t *freelist, nccl_ofi_freelist_elem_t *entry) {
  size_t user_entry_size = freelist->entry_size - MEMCHECK_REDZONE_SIZE;
