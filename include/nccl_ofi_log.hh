...
#define NCCL_OFI_WARN(fmt, ...) (*ofi_log_function)(NCCL_LOG_WARN, NCCL_ALL, __PRETTY_FUNCTION__, __LINE__, "NET/OFI " fmt, ##__VA_ARGS__)

#define NCCL_OFI_INFO(flags, fmt, ...) (*ofi_log_function)(NCCL_LOG_INFO, flags, __PRETTY_FUNCTION__, __LINE__, "NET/OFI " fmt, ##__VA_ARGS__)
