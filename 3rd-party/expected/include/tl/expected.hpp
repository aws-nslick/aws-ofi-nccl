...
constexpr in_place_t static in_place{};
#endif
...
template <class E> constexpr bool operator!=(unexpected<E> const& lhs, unexpected<E> const& rhs) { return lhs.value() != rhs.value(); }
template <class E> constexpr bool operator<(unexpected<E> const& lhs, unexpected<E> const& rhs) { return lhs.value() < rhs.value(); }
template <class E> constexpr bool operator<=(unexpected<E> const& lhs, unexpected<E> const& rhs) { return lhs.value() <= rhs.value(); }
template <class E> constexpr bool operator>(unexpected<E> const& lhs, unexpected<E> const& rhs) { return lhs.value() > rhs.value(); }
template <class E> constexpr bool operator>=(unexpected<E> const& lhs, unexpected<E> const& rhs) { return lhs.value() >= rhs.value(); }
...
constexpr unexpect_t static unexpect{};
...
namespace detail {
struct no_init_t {};
constexpr no_init_t static no_init{};
...
template <class T, class E,
          bool = is_void_or<T, conjunction<TL_EXPECTED_IS_TRIVIALLY_COPY_ASSIGNABLE(T), TL_EXPECTED_IS_TRIVIALLY_COPY_CONSTRUCTIBLE(T),
...
class expected : private detail::expected_move_assign_base<T, E>,
  ...
  template <class U = T, detail::enable_if_t<!std::is_void<U>::value>* = nullptr> TL_EXPECTED_11_CONSTEXPR U& val() { return this->m_val; }
  TL_EXPECTED_11_CONSTEXPR unexpected<E>& err() { return this->m_unexpect; }

  template <class U = T, detail::enable_if_t<!std::is_void<U>::value>* = nullptr> constexpr U const& val() const { return this->m_val; }
...
public:
  ...
  template <class F> TL_EXPECTED_11_CONSTEXPR auto and_then(F&& f) & { return and_then_impl(*this, std::forward<F>(f)); }
  template <class F> TL_EXPECTED_11_CONSTEXPR auto and_then(F&& f) && { return and_then_impl(std::move(*this), std::forward<F>(f)); }
  template <class F> constexpr auto and_then(F&& f) const& { return and_then_impl(*this, std::forward<F>(f)); }

#ifndef TL_EXPECTED_NO_CONSTRR
  template <class F> constexpr auto and_then(F&& f) const&& { return and_then_impl(std::move(*this), std::forward<F>(f)); }
#endif
...
#if defined(TL_EXPECTED_CXX14) && !defined(TL_EXPECTED_GCC49) && !defined(TL_EXPECTED_GCC54) && !defined(TL_EXPECTED_GCC55)
  template <class F> TL_EXPECTED_11_CONSTEXPR auto map(F&& f) & { return expected_map_impl(*this, std::forward<F>(f)); }
  template <class F> TL_EXPECTED_11_CONSTEXPR auto map(F&& f) && { return expected_map_impl(std::move(*this), std::forward<F>(f)); }
  template <class F> constexpr auto map(F&& f) const& { return expected_map_impl(*this, std::forward<F>(f)); }
  template <class F> constexpr auto map(F&& f) const&& { return expected_map_impl(std::move(*this), std::forward<F>(f)); }
#else
  ...
  template <class F> constexpr decltype(expected_map_impl(std::declval<expected const&>(), std::declval<F&&>())) map(F&& f) const& {
    return expected_map_impl(*this, std::forward<F>(f));
  }
...
#if defined(TL_EXPECTED_CXX14) && !defined(TL_EXPECTED_GCC49) && !defined(TL_EXPECTED_GCC54) && !defined(TL_EXPECTED_GCC55)
  template <class F> TL_EXPECTED_11_CONSTEXPR auto transform(F&& f) & { return expected_map_impl(*this, std::forward<F>(f)); }
  template <class F> TL_EXPECTED_11_CONSTEXPR auto transform(F&& f) && { return expected_map_impl(std::move(*this), std::forward<F>(f)); }
  template <class F> constexpr auto transform(F&& f) const& { return expected_map_impl(*this, std::forward<F>(f)); }
  template <class F> constexpr auto transform(F&& f) const&& { return expected_map_impl(std::move(*this), std::forward<F>(f)); }
#else
  template <class F>
  ...
  template <class F> constexpr decltype(expected_map_impl(std::declval<expected const&>(), std::declval<F&&>())) transform(F&& f) const& {
    return expected_map_impl(*this, std::forward<F>(f));
  }
...
#if defined(TL_EXPECTED_CXX14) && !defined(TL_EXPECTED_GCC49) && !defined(TL_EXPECTED_GCC54) && !defined(TL_EXPECTED_GCC55)
  template <class F> TL_EXPECTED_11_CONSTEXPR auto map_error(F&& f) & { return map_error_impl(*this, std::forward<F>(f)); }
  template <class F> TL_EXPECTED_11_CONSTEXPR auto map_error(F&& f) && { return map_error_impl(std::move(*this), std::forward<F>(f)); }
  template <class F> constexpr auto map_error(F&& f) const& { return map_error_impl(*this, std::forward<F>(f)); }
  template <class F> constexpr auto map_error(F&& f) const&& { return map_error_impl(std::move(*this), std::forward<F>(f)); }
#else
  ...
  template <class F> constexpr decltype(map_error_impl(std::declval<expected const&>(), std::declval<F&&>())) map_error(F&& f) const& {
    return map_error_impl(*this, std::forward<F>(f));
  }
...
#endif
#if defined(TL_EXPECTED_CXX14) && !defined(TL_EXPECTED_GCC49) && !defined(TL_EXPECTED_GCC54) && !defined(TL_EXPECTED_GCC55)
  template <class F> TL_EXPECTED_11_CONSTEXPR auto transform_error(F&& f) & { return map_error_impl(*this, std::forward<F>(f)); }
  template <class F> TL_EXPECTED_11_CONSTEXPR auto transform_error(F&& f) && {
    return map_error_impl(std::move(*this), std::forward<F>(f));
  }
  template <class F> constexpr auto transform_error(F&& f) const& { return map_error_impl(*this, std::forward<F>(f)); }
  template <class F> constexpr auto transform_error(F&& f) const&& { return map_error_impl(std::move(*this), std::forward<F>(f)); }
#else
  template <class F>
  ...
  template <class F>
  constexpr decltype(map_error_impl(std::declval<expected const&>(), std::declval<F&&>())) transform_error(F&& f) const& {
    return map_error_impl(*this, std::forward<F>(f));
  }
...
#endif
#endif
  template <class F> expected TL_EXPECTED_11_CONSTEXPR or_else(F&& f) & { return or_else_impl(*this, std::forward<F>(f)); }

  template <class F> expected TL_EXPECTED_11_CONSTEXPR or_else(F&& f) && { return or_else_impl(std::move(*this), std::forward<F>(f)); }

  template <class F> expected constexpr or_else(F&& f) const& { return or_else_impl(*this, std::forward<F>(f)); }

#ifndef TL_EXPECTED_NO_CONSTRR
  template <class F> expected constexpr or_else(F&& f) const&& { return or_else_impl(std::move(*this), std::forward<F>(f)); }
#endif
  ...
  template <class G = E, detail::enable_if_t<std::is_constructible<E, G const&>::value>* = nullptr,
            detail::enable_if_t<!std::is_convertible<G const&, E>::value>* = nullptr>
  explicit constexpr expected(unexpected<G> const& e) : impl_base(unexpect, e.value()), ctor_base(detail::default_constructor_tag{}) {}
  ...
  explicit TL_EXPECTED_11_CONSTEXPR expected(expected<U, G> const& rhs) : ctor_base(detail::default_constructor_tag{}) {
    if (rhs.has_value()) {
      this->construct(*rhs);
    } else {
...
public:
  ...
  template <class U = T, detail::enable_if_t<!std::is_void<U>::value>* = nullptr> constexpr U const& operator*() const& {
    TL_ASSERT(has_value());
    return val();
  }
...
template <class T, class E, class U, class F> constexpr bool operator==(expected<T, E> const& lhs, expected<U, F> const& rhs) {
...
template <class E, class F> constexpr bool operator==(expected<void, E> const& lhs, expected<void, F> const& rhs) {
...
template <class T, class E, class U> constexpr bool operator==(expected<T, E> const& x, U const& v) {
  return x.has_value() ? *x == v : false;
}
template <class T, class E, class U> constexpr bool operator==(U const& v, expected<T, E> const& x) {
  return x.has_value() ? *x == v : false;
}
template <class T, class E, class U> constexpr bool operator!=(expected<T, E> const& x, U const& v) {
...
template <class T, class E> constexpr bool operator==(expected<T, E> const& x, unexpected<E> const& e) {
  return x.has_value() ? false : x.error() == e.value();
}
template <class T, class E> constexpr bool operator==(unexpected<E> const& e, expected<T, E> const& x) {
  return x.has_value() ? false : x.error() == e.value();
}
template <class T, class E> constexpr bool operator!=(expected<T, E> const& x, unexpected<E> const& e) {
