...
static ncclResult_t connect_v5(int dev, void *handle, void **sendComm) { return nccl_net_ofi_connect(dev, handle, sendComm); }

static ncclResult_t accept_v5(void *listenComm, void **recvComm) { return nccl_net_ofi_accept(listenComm, recvComm); }
