...
static ncclResult_t connect_v7(int dev, void *handle, void **sendComm, ncclNetDeviceHandle_v7_t **sendDevComm) {
  return nccl_net_ofi_connect(dev, handle, sendComm);
}

static ncclResult_t accept_v7(void *listenComm, void **recvComm, ncclNetDeviceHandle_v7_t **recvDevComm) { return nccl_net_ofi_accept(listenComm, recvComm); }
