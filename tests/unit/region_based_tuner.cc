...
static int test_extend_region() {
  ...
  extended_point = extend_region((nccl_ofi_tuner_point_t){8, 2}, (nccl_ofi_tuner_point_t){8, 4}, (nccl_ofi_tuner_point_t){TUNER_MAX_SIZE, TUNER_MAX_RANKS});
  ...
  extended_point =
      extend_region((nccl_ofi_tuner_point_t){8, 64}, (nccl_ofi_tuner_point_t){8290304, 72}, (nccl_ofi_tuner_point_t){TUNER_MAX_SIZE, TUNER_MAX_RANKS});
  ...
  extended_point =
      extend_region((nccl_ofi_tuner_point_t){8, 64}, (nccl_ofi_tuner_point_t){16, 1024}, (nccl_ofi_tuner_point_t){TUNER_MAX_SIZE, TUNER_MAX_RANKS});
...
static int test_is_inside_region() {
  ...
  nccl_ofi_tuner_region_t region = {.algorithm = NCCL_ALGO_RING,
                                    .protocol = NCCL_PROTO_SIMPLE,
                                    .num_vertices = 5,
                                    .vertices = {e_48M_16_288M_128, p1_288M_128, p2_38M_16, p3_4M_2, p5_maxM_2}};
  ...
  printf("All points on the vertices of the polygon are detected correctly\n");
  ...
  */
  ...
  const nccl_ofi_tuner_point_t inside_vertices[] = {{16.0 * 1024 * 1024, 4},          {128.0 * 1024 * 1024, 4},
                                                    ...
                                                    {64.0 * 1024 * 1024, 16},         {1.0 * 1024 * 1024 * 1024, 16},
                                                    {4.0 * 1024 * 1024 * 1024, 16},   {16.0 * 1024 * 1024 * 1024, 16},
                                                    {32.0 * 1024 * 1024 * 1024, 16},  {64.0 * 1024 * 1024 * 1024, 16},
                                                    {512.0 * 1024 * 1024, 128},       {4.0 * 1024 * 1024 * 1024, 128},
                                                    {16.0 * 1024 * 1024 * 1024, 128}, {32.0 * 1024 * 1024 * 1024, 128},
                                                    {64.0 * 1024 * 1024 * 1024, 128}, {64.0 * 1024 * 1024 * 1024, 256},
                                                    {TUNER_MAX_SIZE - 1.0, 128},      {e_48M_16_288M_128.x - 1.0, e_48M_16_288M_128.y - 1.0}};
  ...
  printf("All points inside the polygon are detected correctly\n");
